...
[Integer-mode DIB stretching](gdi-dib-stretching.md) adds scaling for modes 1–3;
four HALFTONE references remain failing as the next implementation ratchet.
