...
Imported real-world pairs are in `corpus/`. Existing adjacent `.png` files are
128×128 Windows GDI references from the `windows-2025` runner.
Additional profiles live beside the inputs, e.g. `corpus/257x193/corpus-penny.png`
...
size checks the requested profile even before its directory exists.
