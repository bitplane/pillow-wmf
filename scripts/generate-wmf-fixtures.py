...
def all_cases():
    ...
    yield from runpy.run_path(str(Path(__file__).with_name("palette_fixtures.py")))["cases"]()
    yield from runpy.run_path(str(Path(__file__).with_name("dib_format_fixtures.py")))["cases"]()
...
def pen_radius_probe_cases():
    ...
    profiles = (
        ...
        ("near-circular", 48, (2232, 2218), (128, 128)),
        ("axis-collapse-tie", 6, (412, 1536), (128, 128)),
        ("axis-survives", 6, (412, 1280), (128, 128)),
        ("collapsed-diamond", 8, (324, 2038), (128, 128)),
        ("collapsed-diamond-reflected", 8, (-128, 2048), (128, 128)),
        ("noncollapsed-shoulders", 8, (128, 1920), (128, 128)),
